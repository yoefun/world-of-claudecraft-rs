...
use woc_protocol::{
    AbilitySlot, EntityId, EntityKind, EquipSlot, InteractAction, PlayerIntent, TickSnapshot,
};
...
pub(crate) fn collect_intent(
    ...
    if !ui.show_talents && !ui.show_bank && !loot_rolling && !ui.show_bags && !ui.show_character {
