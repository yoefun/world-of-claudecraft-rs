    ...
    commands
        ...
        .with_children(|root| {
            ...
            .with_children(|top| {
                ...
                top.spawn((
                    Text::new(
                        "LMB/F attack · Tab target · 1–5 abilities · T pet · E interact/loot · B bags (Q/F) · L quests · C sheet (rep) · N talents · K bank (G/H/J/Y) · I mail · M map · U market (L/O/X) · [ ] loot mode · RMB look · Esc clear",
                    ),
                    TextFont::from_font_size(14.0),
