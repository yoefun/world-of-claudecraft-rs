...
pub const ITEM_DEFS: &[ItemDef] = &[
    ...
    ItemDef {
        id: ItemId::ElixirOfMinorStrength,
        quality: Quality::Common,
        slot: EquipSlot::None,
        sell_value: 14,
        buy_value: 0,
