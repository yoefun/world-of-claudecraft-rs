...
18. Two clients: Alice **J** types `Vale Watch` Enter; target Bob **V**; Bob Enter. MOTD via `/motd`; guild chat Enter; `/o` officer. Relog still in guild. Transfer **T**, leave **Q**, disband **D**.
