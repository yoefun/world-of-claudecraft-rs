...
3. Spend talents, cast 3+ abilities, summon a hunter or warlock pet (T). Rogue: **Z** stealth → Cheap Shot opener → Sinister Strike → Eviscerate.
...
Footer reads `WoC-rs 1.7.0 · upstream 0.31.0` (`VERSION.toml`). Rogue **Z** stealth opener; warrior Charge / mage Blink / priest shield / hunter Aspect on slot 5.
