...
**Goal:** Ship rewrite `1.14.0` / `parcel-bank`: slot-accurate bank and mail moves that preserve durability/enchant, offline parcels via a realm character directory, client send/collect/return, postage/inbox cap/expiry, and repair that includes banked gear.
