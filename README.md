...
(`a3e5e9596a8e9e7d37b5b23efbbb0f2cd846c0c9`). Parity target: **`reputation`**.
...
## What works in 1.14.0 (reputation)
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.14.0` / `reputation` (after `1.13.0` / `gear-slots`). Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
