...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.16.0` / `guilds` (after `1.15.0` / `gear-more`). Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
