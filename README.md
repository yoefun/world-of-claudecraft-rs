...
[![Rewrite](https://img.shields.io/badge/rewrite-1.12.0-blue)](VERSION.toml)
...
**Rewrite `1.12.0`** is pinned to upstream **`0.31.0`**
(`a3e5e9596a8e9e7d37b5b23efbbb0f2cd846c0c9`). Parity target: **`gear-depth`**.
...
## What works in 1.12.0 (gear-depth)
...
- Version footer: `WoC-rs 1.12.0 · upstream 0.31.0`
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.12.0` / `gear-depth`. Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
