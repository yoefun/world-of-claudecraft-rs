...
[![Rewrite](https://img.shields.io/badge/rewrite-1.18.0-blue)](VERSION.toml)
...
**Rewrite `1.18.0`** is pinned to upstream **`0.31.0`**
...
- Version footer: `WoC-rs 1.18.0 · upstream 0.31.0`
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.18.0` / `raid`. Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
