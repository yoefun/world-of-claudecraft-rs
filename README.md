...
Controls: **WASD** move, **Space** jump / swim hop / fly up, **Ctrl** descend (swim/fly), **V** travel flight toggle, **mouse** look (hold right), **left click** attack, **1–5** abilities, **T** pet summon/dismiss (hunter/warlock), **E** interact, **B** bags, **L** quests, **C** character, **N** talents (**1–3** spend / Y first available / R respec), **K** bank (G deposit / H withdraw), **I** mail (P collect), **M** world map, **U** market (O buy), **Esc** close map / release cursor. Title: **1/2** or click Offline|Online, **Enter**/Continue. Offline create: **click** or **←/→** class grid, type name, **Enter**. Online login: **Tab** field, **F2**/tabs login|register, **Enter**/Sign in (register asks for password confirm). Char select: click roster or **↑/↓**, **Enter world**, **N**/New character (class grid), **D**/Delete (confirm twice), **Esc** logout.
## Architecture
