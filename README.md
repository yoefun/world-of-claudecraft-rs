...
Design and implementation plan for gathering, forging, skinning, leatherworking, enchanting, engineering, and alchemy:
...
The sim crate (`crates/woc-sim`) is created in Task 1 of the plan, not in this documentation PR.
