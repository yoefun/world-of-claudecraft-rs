...
(`a3e5e9596a8e9e7d37b5b23efbbb0f2cd846c0c9`). Parity target: **`auction-depth`**.
...
## What works in 1.14.0 (auction-depth)
...
- Bank (items + copper vault), mail, auction house (Auctioneer Lise; instance listings; 5% cut; mail proceeds); herbalism → alchemy; mining → blacksmithing
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.14.0` / `auction-depth`. Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
