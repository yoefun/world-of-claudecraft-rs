...
[![Rewrite](https://img.shields.io/badge/rewrite-1.4.0-blue)](VERSION.toml)
...
**Rewrite `1.4.0`** is pinned to upstream **`0.31.0`**
(`a3e5e9596a8e9e7d37b5b23efbbb0f2cd846c0c9`). Parity target: **`client-compat`**.
...
- Version footer: `WoC-rs 1.4.0 · upstream 0.31.0`
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.4.0` / `client-compat`. Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
