...
## What works in 1.22.0 (kill-loop)
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.22.0` / `kill-loop` (after `1.21.0` / `mounts` and `1.20.0` / `parcel-bank`). Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
