...
[![Rewrite](https://img.shields.io/badge/rewrite-1.11.0-blue)](VERSION.toml)
...
**Rewrite `1.11.0`** is pinned to upstream **`0.31.0`**
(`a3e5e9596a8e9e7d37b5b23efbbb0f2cd846c0c9`). Parity target: **`npc-services`**.
...
## What works in 1.11.0 (npc-services)
...
- Version footer: `WoC-rs 1.11.0 · upstream 0.31.0`
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.11.0` / `npc-services`. Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
