...
(`a3e5e9596a8e9e7d37b5b23efbbb0f2cd846c0c9`). Parity target: **`raid`**.
...
See [`docs/ROADMAP.md`](docs/ROADMAP.md). **Shipped:** `1.15.0` / `raid`. Manual demo: [`docs/parity/DEMO.md`](docs/parity/DEMO.md).
